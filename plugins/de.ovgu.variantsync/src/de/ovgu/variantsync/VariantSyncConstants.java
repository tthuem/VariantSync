...
public final class VariantSyncConstants {
	...
	public static final String CHANGES_PATH = "/variantsyncFeatureInfo/context/changes/";
	public static final String BASE_VERION = "/BaseVersion.java";
	public static final String NEW_VERION = "/NewVersion.java";
	...
	public static final String MERGE_OUTPUT = ResourcesPlugin.getWorkspace().getRoot().getLocation().toString()
			+ VariantSyncConstants.MERGE_PATH + "\\Merge.java";
	public static final String MERGE_FOLDER = ResourcesPlugin.getWorkspace().getRoot().getLocation().toString()
