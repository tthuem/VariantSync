...
public enum CodeHighlighting {
	...
	DEFAULTCONTEXT(new RGB(255, 255, 255)), GREEN(new RGB(88, 174, 10)), BLUE_BRIGHT(new RGB(151, 255, 255)), BLUE(
			new RGB(135, 206, 235)), PURPLE(new RGB(167, 76, 242)), PINK(new RGB(205, 67, 211)), RED(
					new RGB(255, 140, 105)), ORANGE(new RGB(240, 170, 84)), YELLOW(new RGB(243, 241, 79)), GREEN_BRIGHT(
							new RGB(70, 244, 69)), GREY_BRIGHT(new RGB(200, 200, 200));
