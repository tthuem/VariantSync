...
public interface Persistable {
	 ...
	 */
	List<String> readFile(InputStream inputStream) throws FileOperationException;
	 ...
	 * @throws FileOperationException
	 */
	List<String> readFile(InputStream in, String charset) throws FileOperationException;
	...
	/**
	 * Reads feature expressions from the specified location.
	 *
	 * @param path
	 *            location of feature expressions
	 * @return
	 */
